...
<div class="main_box">
 	<form class="from" name="LoginForm" method="post" action="login.php" onSubmit="return InputCheck(this)">  
		<p>  
		...
		<p/>  
		<p>  
			<input class="submit" type="submit" name="submit" value="  登  录  " class="left" />  
		</p>  
	</form>  
</div>
<center>
